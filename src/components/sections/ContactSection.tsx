      ...
      >
        <div className="container">
          <div className="flex flex-col justify-between sm:gap-[20px] md:flex-row">
            ...
            <div>
              <p className="font-inter mt-6 flex-grow text-[17px] font-medium leading-[120%] text-white sm:mt-0 sm:text-[18px] md:mt-[13px] md:max-w-[450px] md:text-right lg:mt-[27px] lg:max-w-[393px] lg:text-right">
          ...
          >
            <div className="flex w-full flex-col gap-[24px] sm:gap-[40px] lg:w-3/4 lg:gap-[70px]">
              <div className="flex flex-col gap-[24px] sm:flex-row sm:gap-[20px] lg:gap-[120px]">
                <div className="font-inter flex w-full flex-col gap-[10px] text-[17px] font-medium text-white sm:w-1/2 sm:text-[18px]">
                  Name *
                  <input
              ...
              <div className="font-inter flex flex-col gap-[10px] text-[17px] font-medium text-white sm:w-1/2 sm:text-[18px] md:w-[70%] lg:w-full">
                Message *
                <textarea
            ...
            <Magnetic>
              <button
                className="font-inter mx-auto flex h-[180px] w-[180px] items-center justify-center rounded-full bg-blue text-lg font-medium text-white outline-none transition hover:bg-blueHover sm:absolute sm:bottom-0 sm:right-0"
                type="submit"
              >
                Submit
              </button>
